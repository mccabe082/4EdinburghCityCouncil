# 7. Master Bedroom
## 7.1. Master Bedroom: interior window surrounds
...
Window catch/release is slightly misaligned and requires force to operate due to slight warping

## 7.4. Master Bedroom Door

Door now rubs against carpet on opening when it didn't previously | Note: it was the appearence of this issue along w/the identical issues w/the ensuite; lounge and cuboard doors that first alerted us to potential structural movement

## 7.5. Master Bedroom Ceiling
